...
export function BitdefenderConnectionPicker({
  connections,
  selectedId,
  basePath,
}: {
  connections: Pick<BitdefenderConnection, "id" | "name">[];
  selectedId: string;
  basePath: string;
}) {
  ...
  return (
    <div className="space-y-1.5">
      <Label className="text-xs font-medium text-muted-foreground">Conta GravityZone</Label>
